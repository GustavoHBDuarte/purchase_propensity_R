...
df %>% 
  select(vehicle_age, vehicle_damage, driving_license, gender, response) %>%
  as.data.table %>% 
  v_cramer_all(cat_var = c("vehicle_age", "vehicle_damage", "driving_license", "gender", "response"), df = df)
